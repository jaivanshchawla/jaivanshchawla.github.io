        ...
        {cards.map((card) => (
          ...
          >
            ...
            <motion.button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.backgroundColor = card.ctaColor;
