...
const LampContainer = React.lazy(() => import("./components/ui/lamp").then(module => ({ default: module.LampContainer })));
const TiltedCard = React.lazy(() => import("./components/card/TiltedCard"));
const GlowEffect = React.lazy(() => import("./components/card/gloweffect").then(module => ({ default: module.GlowEffect })));
const ExpandableCardDemo = React.lazy(() => import("./components/expandcard/standard").then(module => ({ default: module.ExpandableCardDemo })));
const ExpandableCardGrid = React.lazy(() => import("./components/expandcard/grid").then(module => ({ default: module.ExpandableCardGrid })));
const Manipal = React.lazy(() => import("./components/motion-primitives/MUJ").then(module => ({ default: module.Manipal })));
const Presidium = React.lazy(() => import("./components/motion-primitives/PRES").then(module => ({ default: module.Presidium })));
const Tibraze = React.lazy(() => import("./components/motion-primitives/differ").then(module => ({ default: module.Tibraze })));
const CaseStudyCard = React.lazy(() => import("./components/card/casecard"));
const IntegrationPills = React.lazy(() => import("./components/ui/pills"));
